      ...
      return [
        () => {
          return (tree: Root, file) => {
            ...
            const allSlugs = ctx.allSlugs // ctx에서 allSlugs를 가져옵니다
            ...
            if (opts.wikilinks) {
              replacements.push([
                ...
                (value: string, ...capture: string[]) => {
                  ...
                  // 파일 존재 여부 확인
                  const slug = slugifyFilePath(fp as SimpleSlug)
                  const exists = allSlugs.includes(slug as FullSlug)
