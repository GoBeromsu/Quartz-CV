...
**퍼사드 패턴**: 복잡한 하위 시스템에 대한 **간단한 인터페이스**를 제공하여 사용자가 시스템의 내부 복잡성을 알 필요 없이 기능을 사용할 수 있게 합니다. **DI(의존성 주입)**: 객체가 자신의 **의존성을 외부에서 주입받는 방식**을 정의하여 객체 간의 결합도를 낮추고, 유연성과 테스트 용이성을 향상시킵니다.
